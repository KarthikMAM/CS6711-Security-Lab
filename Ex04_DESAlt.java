...
public class Ex04_DESAlt {
	...
	public static String f(String r, String key) {
		...
		for (int i = 0; i < 8; i++) {
			...
			//System.out.print(" (" + toBinString(S[i][row * 16 + col], 4) + ") ");
		}
	...
	public String crypt(String msg, boolean encrypt) {
		...
		String l = msg.substring(0, 32);
		String r = msg.substring(32, msg.length());
		for (int i = 0; i < 16; i++) {
			String temp = r;
	...
	public static void main(String[] args) {
		String msg = toBinString(new BigInteger("Hello".getBytes()).longValue(), 64);
		String key = toBinString(0x133457799BBCDFF1L, 64);
		
		Ex04_DESAlt x = new Ex04_DESAlt(key);
		
		System.out.println(msg);
		System.out.println(x.crypt(msg, true));
		System.out.println(x.crypt(x.crypt(msg, true), false));
	}
